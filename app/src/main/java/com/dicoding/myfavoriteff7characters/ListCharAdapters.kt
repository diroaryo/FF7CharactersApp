...
class ListCharAdapters(private val listCharacters: ArrayList<Characters>) : RecyclerView.Adapter<ListCharAdapters.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, description, photo) = listCharacters[position]
